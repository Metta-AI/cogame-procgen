...
# Substitute: procgen, coworld-procgen, 1.
#
...
#
# env:
#   SMOKE_IMAGE                image, if not given as $1        (coworld-procgen:ci)
#   SMOKE_SLUG                 game slug                        (procgen)
#   SMOKE_GAME_BIN             game entrypoint                  (/bin/procgen)
#   SMOKE_PLAYER_BIN           player entrypoint                (/bin/procgen-player)
...
image="${1:-${SMOKE_IMAGE:-coworld-procgen:ci}}"
slug="${SMOKE_SLUG:-procgen}"

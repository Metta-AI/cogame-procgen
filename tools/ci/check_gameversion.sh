...
#
# Kept from coworld-ctf's tools/ci/check_gameversion.sh with ONE named edit:
# CONST_FILE points at this fork's src/procgen/sim_types.nim.
#
# Usage:
...
HEAD_REF="${2:-HEAD}"
CONST_FILE="src/procgen/sim_types.nim"
